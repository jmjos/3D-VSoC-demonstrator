...
//                double ADC_length_x = 0;
//                double ADC_length_y = 0;
...
//                cout << "ADC diff x" << ADC_length_x << endl;
//                cout << "ADC diff y" << ADC_length_y << endl;
//                ADC_length_x -= CPU_width_height[i].x;
//                ADC_length_y -= CPU_width_height[i].y;
//                cout << "ADC diff x" << ADC_length_x << endl;
//                cout << "ADC diff y" << ADC_length_y << endl;
            }
